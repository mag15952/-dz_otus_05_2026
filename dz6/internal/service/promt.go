...
func PlayChessNew(player players.Player, length int, chessboard *chessboard.Chessboard) {
...
/*func setCommands(player string) (bool, int, string) {

	var move string
	var movecount int

	items := []string{"Ввести ход", "Сдался", "Автоход"}
...
func PlayChess(player players.Player, length int, chessboard *chessboard.Chessboard) {
...
func printAllAgain(player players.Player, chessboard *chessboard.Chessboard) {
